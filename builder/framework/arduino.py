...
env.Append(
    ...
    CPPPATH=[
        join(FRAMEWORK_DIR, "cores", board.get("build.core"), "native", "include"),
        join(FRAMEWORK_DIR, "cores", board.get("build.core"), "native", "include", "ril"),
    ...
    LIBPATH=[
        join(FRAMEWORK_DIR, "cores", board.get("build.core"), "native", "lib")
    ],
